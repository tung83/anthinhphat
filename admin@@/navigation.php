...
function ad_menu()
{
	$topNav=array(
                    ...
                    array(3,'Danh sách xe','product','qrcode'),
                    array(2,'Quản lý dịch vụ',"serv","star"),
	...
	$subNav=array(
                    array(2,'Danh mục dịch vụ','type=serv_cate'),
                    /*array(2,'Danh mục sản phẩm cấp 2','type=product_cate_2'), */
                    array(2,'Danh sách dịch vụ','type=serv'), 
                    array(3,'Danh mục xe','type=product_cate'),
                    array(3,'Danh sách xe','type=product'),
